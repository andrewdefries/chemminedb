""" to add an compound level text file for an existing screen """
""" to be run on chemmine, as text file is to be 
...
from screendb.models import Screen,	TextFile
...
# save the text file on chemmine server
