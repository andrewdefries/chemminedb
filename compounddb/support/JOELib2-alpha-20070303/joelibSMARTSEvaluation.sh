...
#                       joelib2.smarts.test.SMARTSEvaluation \
#                      $@

echo SMARTS testing result file will be written to: evaluationResult.txt

${JAVA_HOME}/bin/java  -classpath ${CLASSPATH} \
                       joelib2.smarts.test.SMARTSEvaluation \
                      src/resources/smartsEvaluation \
                      src/resources/smartsEvaluation/evaluation.txt \
                      smartsEvaluationResult.txt \
                      error

echo Successfull: SMARTS testing result file written to: smartsEvaluationResult.txt
