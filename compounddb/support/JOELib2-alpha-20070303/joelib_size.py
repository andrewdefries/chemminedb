...
def gen_joelib(sdf):
    ...
    cmd = \
        'JAVA_HOME=/usr/lib/jvm/java-1.5.0-sun/jre/ JOELIB2=/home/lwang/JOELib2-alpha-20070303 /home/lwang/JOELib2-alpha-20070303/moleculeConversion.sh +d -iSDF -oSDF "%s" "%s"' \
        % (sdf, out)
    os.system(cmd)
...
if __name__ == '__main__':
    ...
    for i in iid_fp:
        ...
        joelib_fp = \
            file('/home/lwang/proposals/2_MLSMR/joelib/%s.joelib'
                 % iid, 'w')
